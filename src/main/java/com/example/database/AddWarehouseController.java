...
public class AddWarehouseController {
    ...
    @FXML
    private ComboBox<?> id_comboBoxNomenclatura;
    ...
    public void AddWarehouse(ActionEvent actionEvent) {
        ...
        GetValue = String.valueOf(id_comboBoxNomenclatura.getSelectionModel().getSelectedIndex());
        ...
        try(Connection con = DriverManager.getConnection("jdbc:postgresql://46.229.214.241:5432/vasiltsova_awtozaprawka", dbConnection.username, dbConnection.password)){
            ...
            int rows = statement.executeUpdate("INSERT INTO public.cklad(naimenovanie, id_nomenklatyra, kolichestvo_cklad) VALUES('" + id_name.getText() + "', '" + idNomenclature + "', '" + id_amount.getText() + "')");
        statement.close();
    ...
    public void ComboBoxNomenclature(){
        ...
        try(Connection con = DriverManager.getConnection("jdbc:postgresql://46.229.214.241:5432/vasiltsova_awtozaprawka", dbConnection.username, dbConnection.password)){
            ...
            while(rs.next()){
                ...
                id_comboBoxNomenclatura.getItems().addAll(listNom);
                id_comboBoxNomenclatura.getSelectionModel().select(0);
